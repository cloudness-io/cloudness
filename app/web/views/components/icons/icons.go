...
const (
	...
	DeployIcon       = "ph ph-rocket"
	AddIcon          = "ph ph-plus"
	HiddenIcon       = "ph ph-eye-slash"
	ShownIcon        = "ph ph-eye"
	EditIcon         = "ph ph-pencil"
	CancelIcon       = "ph ph-x"
	SuccessIcon      = "ph ph-check text-success"
	MenuDropdownIcon = "ph ph-dots-three-vertical"
	...
	LogsSectionIcon          = "ph ph-notepad text-brand"
	NetworkSectionIcon       = "ph ph-network"
	CertificateIcon          = "ph ph-certificate text-yellow-400"
	VolumeSectionIcon        = "ph ph-hard-drives text-blue-400"
	NetworkPublicSectionIcon = "ph ph-globe"
	EnvironmentVariablesIcon = "ph ph-brackets-curly text-violet-400"

	DeploymentIcon = "ph ph-rocket text-cyan-700"
	TerminalIcon   = "ph ph-terminal-window text-yellow-600"
