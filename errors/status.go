...
const (
	...
	StatusBadRquest          Status = "bad_request"
...
// BadRequest is a helper function to return an bad request Error.
func BadRequest(format string, args ...interface{}) *Error {
	return Format(StatusBadRquest, format, args...)
}
...
// IsBadRequest checks if err is bad request error.
func IsBadRequest(err error) bool {
	return AsStatus(err) == StatusBadRquest
}
